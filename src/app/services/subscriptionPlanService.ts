...
function buildPlanPayload(
    ...
    return {
        ...
        plan_credit_amount: definition.creditAmount,
        plan_credit_label: definition.creditLabel,
        plan_credit_is_unlimited: definition.creditIsUnlimited,
        plan_credit_period: definition.creditPeriod,
